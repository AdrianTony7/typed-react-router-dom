...
export const sampleRoutes = {
    ...
    VIEW_SERVICE: { path: '/services/:id', name: 'View Service', parent: '/services', icon: MessageSquareIcon },
    ...
    ACADEMY_COURSE: { path: '/academy/courses/:id', name: 'Course', parent: '/academy/courses', icon: BookOpenIcon },
    ACADEMY_COURSE_LESSONS: { path: '/academy/courses/:id/lessons', name: 'Lessons', parent: '/academy/courses', icon: BookOpenIcon },
    ACADEMY_COURSE_LESSON: { path: '/academy/courses/:id/lessons/:lessonId', name: 'Lesson', parent: '/academy/courses', icon: BookOpenIcon },
    ...
    ADMIN_VIEW_USER: { path: "/figpe-admin-x4/users/:id", name: "View User", parent: '/figpe-admin-x4', icon: UserIcon },
    ADMIN_EMAIL_USER: { path: "/figpe-admin-x4/users/:id/email", name: "Email User", parent: '/figpe-admin-x4/users', icon: MessageSquareIcon },
    ...
    ADMIN_VIEW_COURSE: { path: "/figpe-admin-x4/view-course/:id", name: "View Course", parent: '/figpe-admin-x4/courses', icon: BookOpenIcon },
    ADMIN_ADD_COURSE: { path: "/figpe-admin-x4/add-course", name: "Add Course", parent: '/figpe-admin-x4/courses', icon: BookOpenIcon },
    ADMIN_EDIT_COURSE: { path: "/figpe-admin-x4/edit-course/:id", name: "Edit Course", parent: '/figpe-admin-x4/courses', icon: BookOpenIcon },
